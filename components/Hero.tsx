  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1600px]">
        <div className="grid grid-cols-1 items-start gap-8 xl:grid-cols-[minmax(0,1fr)_270px] xl:gap-8">
          <div className="min-w-0">
            <div className="mx-auto flex w-full max-w-7xl flex-col space-y-12">
              <header className="w-full text-center">
                ...
                <p className="mx-auto mt-3 max-w-3xl text-base leading-relaxed text-white/65 sm:text-lg">
                  {t("steamPrivacyHint")}{" "}
                  <a
                ...
                <StatsRow stats={heroStats} className="mt-8 justify-center" />
              </header>
        ...
        <LandingCommunitySidebar
          {...sidebarProps}
          className="mx-auto mt-8 max-w-[280px] xl:hidden"
        />
      </div>
    </section>
  );
