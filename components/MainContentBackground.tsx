export function MainContentBackground() {
  return (
    <div
      aria-hidden="true"
      className="statrealm-main-background pointer-events-none absolute inset-0 -z-10 overflow-hidden"
    >
      <div className="statrealm-main-bg-base absolute inset-0" />
      ...
      <div className="statrealm-main-bg-vignette absolute inset-0" />
    </div>
  );
}
